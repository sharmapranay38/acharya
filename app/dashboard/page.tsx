                  ...
                  <div className="space-y-4">
                    <div className="flex items-center">
                      ...
                      <div className="flex-1">
                        <div className="text-sm font-medium">Flashcards: Machine Learning Basics</div>
                        <div className="text-xs text-muted-foreground">Reviewed 20 cards</div>
                      </div>
                    ...
                    <div className="flex items-center">
                      <div className="w-2 h-2 rounded-full bg-primary mr-2"></div>
                      <div className="flex-1">
                        <div className="text-sm font-medium">Summary: Introduction to Neural Networks</div>
                        <div className="text-xs text-muted-foreground">Read summary</div>
                      </div>
                    ...
                    <div className="flex items-center">
                      <div className="w-2 h-2 rounded-full bg-primary mr-2"></div>
                      <div className="flex-1">
                        <div className="text-sm font-medium">Podcast: History of Computing</div>
                        <div className="text-xs text-muted-foreground">Listened for 15 minutes</div>
                      </div>
                    ...
                    <div className="flex items-center">
                      <div className="w-2 h-2 rounded-full bg-primary mr-2"></div>
                      <div className="flex-1">
                        <div className="text-sm font-medium">Uploaded: Data Structures PDF</div>
                        <div className="text-xs text-muted-foreground">Generated learning materials</div>
                      </div>
